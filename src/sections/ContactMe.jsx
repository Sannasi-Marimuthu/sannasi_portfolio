      ...
      <div className="container mx-auto py-10">
        <div className="w-full lg:w-[60vw] mx-auto">
          ...
          <p className="text-sm text-center mt-4 leading-6">
            A versatile MERN stack developer with hands-on experience in modern tools and frameworks, focused on creating efficient, scalable, and user-centered web solutions.
